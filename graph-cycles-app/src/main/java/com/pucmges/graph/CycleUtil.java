...
public class CycleUtil {
	 ...
	 * 
	 * 
	 Uma base de ciclo de um gráfico não direcionado é um conjunto de ciclos simples que formam
	* uma base do espaço do ciclo do gráfico. Ou seja, é um conjunto mínimo de
	...
	* diferença dos ciclos da base.
	...
	private List<List<Vertex>> computeCycleBasisOfGraph(Graph g) {
		// Copia do grafo, para não alterar o grafo original
